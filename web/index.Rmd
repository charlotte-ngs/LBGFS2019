...
### Exercise Platform
The exercise platform can be used to work on the exercises. The platform will be available soon.
...
# define course start date
dCourseStart <- as.Date("2019/09/21")
# set number of weeks in semester
nNrSemesterWeeks <- 14
# define columns for weaks, dates, and subjects
...
# subjects per week
### # w1
# vecCnTopic[which(Date == format(as.Date("2019/09/20"), "%d.%m"))] <- "[]()"
### # w2
# vecCnTopic[which(Date == format(as.Date("2019/09/27"), "%d.%m"))] <- "[]()"
### # w3
...
### # assign slides
### # w1 
# vecSlTopic[which(Date == format(as.Date("2019/09/20"), "%d.%m"))] <- "[]()"
### # w2
# vecSlTopic[which(Date == format(as.Date("2019/09/27"), "%d.%m"))] <- "[]()"
### # w3
...
# w2
# vecExTopic[which(Date == format(as.Date("2019/09/27"), "%d.%m"))] <- "[]()"
# w3
...
### # w1
# vecAddMatTopic[which(Date == format(as.Date("2019/09/20"), "%d.%m"))] <- "[]()"

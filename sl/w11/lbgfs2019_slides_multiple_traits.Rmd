...
* If traits in $a$ and $\hat{a}$ are the same and $\hat{a}$ were estimated using BLUP, then $b = w$
...
* First possible implementation
    ...
    + Combine $\hat{a}$ with appropriate $b$-values
    
* Imrprovement
    + get $\hat{a}$ from multivariate analysis

...
The off-diagonal elements $(A)_{ij}$ equals the numerator of the coefficent of relationship between animals $i$ and $j$. Multiplying the matrix $A$ by the additive genetic variance $\sigma_u^2$ leads to the covariance among breeding values. Thus if $u_i$ is the breeding value of animal $i$ then 
...
The material shown in this section is based on chapter 15 of [@FM1996]. (TBC)
-->
